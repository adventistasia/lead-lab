        ...
        <FieldGroup>
            ...
            <Field data-invalid={Boolean(form.errors.resource)}>
                ...
                <Input
                    id="resource"
                    type="file"
                    accept=".pdf,.doc,.docx,.txt,.ppt,.pptx,.jpg,.jpeg"
                    onChange={(event) =>
                        form.setData(
                            'resource',
                ...
                <FieldDescription>
                    {resourceTitle
                        ...
                        : ''}
                    Accepted formats: PDF, DOC, DOCX, TXT, PPT, PPTX, JPG, and
                    JPEG, up to 10 MB. Stored outside the public web directory
                    and downloaded through an authenticated route.
                </FieldDescription>
