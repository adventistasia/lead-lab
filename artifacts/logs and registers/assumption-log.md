...
| AL-04 | No formal budget is available; team resources and possibly a domain name are sufficient | Constraint | Requester + IT team | Active | Stated in request brief. Confirm domain availability during platform selection | Platform cost or domain not covered |
...
Assumptions and constraints taken from the accepted request brief (`alson-project-intake/leadlab-rebuild/stages/01-build/output/request-brief.md`, Constraints and Assumptions; Risks and Open Questions). Source notations retained from the brief.
