...
|----|-------------------|-------|--------|--------------|---------|-----------|-----------|
| D-01 | Which platform replaces SharePoint? (website builder, WordPress, custom code) | Requester + IT team; final OK from LeadLab Director | Decided | 13-Aug-2026 | Self-hosted WordPress (O-03) on the team's own server | Best balance of timeline fit, feature scope, customization, restricted access, and cost; production readiness remains subject to D-05 and prototype validation | platform-selection-decision.md, Recommendation |
| D-02 | How do participants get restricted access? (SSO, login, email-list gating) | Requester + IT team | Decided | 18-Aug-2026 | Native WordPress login is sufficient for the prototype; SSO and email-list gating are not required in this phase | Native login is adequate for the current prototype and allows the team to focus on theme and feature validation; restricted-access behavior still needs staging tests | Conversation (PM direction, 2026-08-18); request brief, Risks and Open Questions |
| D-03 | Who maintains WordPress and the server after the Sep 11 launch? | Requester + IT team | Decided | 18-Aug-2026 | IT team will maintain WordPress and the server after launch | Assigning IT resolves the ownership gap; operating procedures still need confirmation before launch | Conversation (PM direction, 2026-08-18); request brief, Risks and Open Questions |
...
| D-05 | Is the team's server ready for WordPress, and is a domain name available? | Requester + IT team | Open | Before production deployment | WordPress is deployed on the team's server in staging. Production domain selection and registration, DNS, SSL, backups, and uptime responsibility are deferred to a later project stage. | The prototype can proceed on staging; production readiness remains required before launch | Conversation (PM update, 2026-08-18); request brief, Constraints and Assumptions |
...
Initial open decisions and stated positions came from the accepted request brief (`alson-project-intake/leadlab-rebuild/stages/01-build/output/request-brief.md`). D-02, D-03, and D-05 current states were updated from the Requester's PM update on 18-Aug-2026. D-09 outcome was recorded 13-Aug-2026 from conversation with the Requester.
...
- 18-Aug-2026: D-02 decided: native WordPress login is sufficient for the prototype; SSO and email-list gating are not required in this phase.
- 18-Aug-2026: D-03 decided: the IT team will maintain WordPress and the server after launch.
- 18-Aug-2026: WordPress deployed on the team's server in staging; D-05 production readiness work deferred to a later project stage.
