...
|----|------------|-------|--------|-----------|-----------------|--------|
| DEP-01 | Platform decision (D-01) | Requester + IT team | Open | Before build start (mid-Aug 2026) | All build work blocked | Shortlist 2-3 platforms against timeline and restricted-access needs; decide |
