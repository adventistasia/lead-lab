...
| DEP-02 | Access mechanism decision (D-02) | Requester + IT team | Critical | Met | Before build start | Build effort and participant email data handling unresolved | Confirmed 18-Aug-2026: D-02 Made (approved-email/password). Implement and test gating before build | D-02, R-03, ISS-02, AL-10 | Client response to PM questions, 18-Aug-2026 (conversation; no written record yet); PM confirmation 2026-08-18 | 2026-08-18 |
...
| DEP-05 | Domain name availability and server readiness for WordPress | Requester + IT team | Critical | Open | During platform selection | Hosting choice constrained; build work blocked | Staging confirmed by PM 18-Aug-2026 (D-05 pending): production DNS, SSL, backups, and uptime responsibility still to be confirmed | D-05, R-08, R-09, R-10, AL-08 | projects/lead-lab/artifacts/logs and registers/dependencies-log.md; PM confirmation 2026-08-18 | 2026-08-18 |
