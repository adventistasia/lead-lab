...
| R-03 | Access design undecided; participants must not get public access | Requester + IT team | Open | 9 | Public access possible if gating not implemented | Approved-email/password mechanism stated by client (D-02 Proposed). Implement gating pre-build and test restricted access. Residual risk: password may be shared (AL-10, client-stated no-go). Proposed status: Mitigated | D-02, ISS-02, DEP-02, AL-10 | Client response to PM questions, 18-Aug-2026 (conversation; no written record yet); projects/lead-lab/artifacts/logs and registers/risk-register.md | 2026-08-18 |
| R-04 | Participant email data handling unclear; privacy rules not confirmed | Requester + IT team | Open | 9 | Email addresses collected or stored on new platform without privacy confirmation | Approved-email approach implies storing participant emails; confirm privacy and data-handling rules before collecting data. Content-sharing rule stated by client (AL-10) | D-02, ISS-04, AL-10 | Client response to PM questions, 18-Aug-2026 (conversation; no written record yet); projects/lead-lab/artifacts/logs and registers/risk-register.md | 2026-08-18 |
| R-05 | Ongoing ownership after Sep 11 launch unassigned (WordPress + server) | Requester + IT team | Open | 6 | Portal live with no assigned maintainer | Confirm WordPress and server maintenance owner before launch | D-03, ISS-05 | projects/lead-lab/artifacts/logs and registers/risk-register.md | 2026-08-18 |
...
| R-07 | YouTube hosting dependency undecided for the new platform | Requester + IT team | Open | 4 | Platform chosen that cannot embed or host videos | Confirm video hosting approach during platform selection | D-04, ISS-06, DEP-04 | projects/lead-lab/artifacts/logs and registers/risk-register.md | 2026-08-18 |
| R-08 | Server or WordPress security compromised (patches not applied) | IT team | Open | 12 | No update schedule; admin credentials shared | Set IT patch schedule; restrict admin access; apply WordPress and OS updates | D-05, DEP-05 | projects/lead-lab/artifacts/logs and registers/risk-register.md | 2026-08-18 |
| R-09 | Backups not configured; content loss on server failure | IT team | Open | 12 | Server fails with no backup | Configure automated backups before launch; test restore | D-05, DEP-05, AL-09 | projects/lead-lab/artifacts/logs and registers/risk-register.md | 2026-08-18 |
| R-10 | Server availability not guaranteed; portal offline | IT team | Open | 9 | Server down; no monitoring or recovery plan | Monitor uptime; define recovery procedure; confirm outage communication | D-05, DEP-05 | projects/lead-lab/artifacts/logs and registers/risk-register.md | 2026-08-18 |
