...
Next action: load the canonical scope file before deciding whether an issue is within the approved product boundary.
...
- Use `pm-control/registers/` for current decisions, risks, issues, dependencies, actions, and changes.
