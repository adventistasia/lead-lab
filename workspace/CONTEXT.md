...
Technical delivery workspace for the private, self-hosted Lead Hub web application. It follows the Interpretable Context Methodology (ICM) through scoped stage contracts and plain-text handoffs.
