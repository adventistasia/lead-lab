...
Next action: write the execution plan and acceptance matrix, identify safe fix-screenshot evidence, update relevant PM Control records, and only then route to Define.
