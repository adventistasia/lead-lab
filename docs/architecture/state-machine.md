...
verified: 2026-09-08
---
# Lead Hub state machines
**AI-generated by:** Alson (A.I Agent)

Lead Hub has three operational lifecycles: access, Learning Sessions, and reminder deliveries. `CONCEPTS.md:5-10`, `CONCEPTS.md:44-46`, `application/source/app/Models/CalendarEventReminderDelivery.php:39-47`
...
`pending`, `active`, and `revoked` are the defined Access Status values. An active user must also have `is_active = true` to access Lead Hub. `application/source/app/Models/User.php:41-45`, `application/source/app/Models/User.php:95-98`
