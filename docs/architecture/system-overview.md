...
|---|---|
| Only active accounts with `access_status = active` can enter Lead Hub. | `application/source/app/Models/User.php:95-98`, `application/source/app/Http/Middleware/EnsureActiveUser.php:12-29` |
